...
for i = 1:paramsLength
    ...
    switch key
        case 'dataFileListingTemplate' 
            dataFileListingTemplate = correctValues;
        case 'rgbFileNameTemplate' 
            rgbFileNameTemplate = correctValues;
        case 'depthMapFileNameTemplate' 
            depthMapFileNameTemplate = correctValues;
        ...
        case 'trainOnDepthMaps'
            trainOnDepthMaps = correctValues;
        case 'numRepeats'
...
fileNames = struct(...
    'dataFileListing', cell(1, 1), ...
    'dataFileListingTemplate', dataFileListingTemplate, ...
    'rgbFileNameTemplate', rgbFileNameTemplate, ...
    'depthMapFileNameTemplate', depthMapFileNameTemplate, ...
...
constParams = struct(...
    ...
    'trainOnDepthMaps', trainOnDepthMaps, ...
...
[dateFileListing] = prepareDateFileListing(fileNames, constParams);
fileNames.dataFileListing = dateFileListing;
...
function [dateFileListing] = prepareDateFileListing(fileNames, constParams)
    if constParams.trainOnDepthMaps
        dateFileListing = fileNames.dataFileListingTemplate + fileNames.depthMapFileNameTemplate;
    else
        dateFileListing = fileNames.dataFileListingTemplate + fileNames.rgbFileNameTemplate;
    end
end